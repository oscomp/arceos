...
unsafe extern "C" fn _start() -> ! {
    core::arch::naked_asm!("
        ...
        csrrd       $t0, 0x4
        bstrins.d   $t0, $zero, 18, 16
        csrwr       $t0, 0x4
        la.global   $t0, exception_entry_base   # Set trap to handle unaligned exception
        csrwr       $t0, 0x0c
...
unsafe extern "C" fn _start_secondary() -> ! {
    core::arch::naked_asm!("
        ...
        li.w         $t0,  0x1028          # LA_IOCSR_MAIL_BUF1  Load Stack Pointer From Message Buffer
        iocsrrd.d    $sp,  $t0
...
#[unsafe(no_mangle)]
#[unsafe(link_section = ".text.boot")]
unsafe extern "C" fn _second_panic() -> ! {
    core::arch::naked_asm!("
        li.d         $t2, 0x800000001FE20000
    1:
